...
export const staff: Person[] = [
  {
    ...
    bio: 'Taylor is very excited for her second year as Director of Cactus Wren. After her daughter attended in 2024, Taylor fell in love with the school. Her background in early childhood education and office management will enable her to keep the legacy of Cactus Wren alive for years to come.',
  },
  {
    name: 'Patsy Romero',
    role: 'Pre-K Teacher',
